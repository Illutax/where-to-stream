...
/** Placeholder rows shown while loading (see {@link FlatrateTable.loading}) — never rendered as real data. */
const SKELETON_ROWS: FlatrateEntry[] = Array.from({ length: 6 }, (_, i) => ({
  isRated: false,
  name: '',
