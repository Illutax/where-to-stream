...
/**
 * A title's age rating. {@link RatingSystem#FSK} carries the German FSK label
 * ({@code 0/6/12/16/18}, shown in the FSK colour scheme); {@link RatingSystem#OTHER} carries a
 * foreign primary certificate (e.g. the US {@code R}/{@code PG-13}) used as a fallback when no
 * German rating exists.
 */
