...
/**
 * Admin cache-maintenance operations Title Catalog exposes to whatever orchestrates the
 * (global, ADMIN-only) cache warm-up — today {@code CacheManagementService}, spanning titles
 * and streaming availability.
 * The caller supplies which titles to warm (e.g. every distinct watchlist imdbId);
