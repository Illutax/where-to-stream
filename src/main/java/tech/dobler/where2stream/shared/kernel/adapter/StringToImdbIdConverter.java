 ...
 * {@code GET /api/search?imdbId=tt…}).
 * A malformed value fails conversion, which Spring MVC turns into a 400
 * — the validation lives in {@code ImdbId}.
 * Spring Boot auto-registers {@code Converter} beans into the MVC conversion service.
 */
@Component
