...
/**
 * An IMDb title id (e.g. {@code tt0482571}). A value object over the former bare {@code String}:
 * construction validates the {@code tt\w+} format in one place, so an {@code ImdbId} in hand is
 * always well-formed and can't be confused with an arbitrary string.
 *
